namespace Omu.Awem.Helpers
{
    ...
    public class ComboboxCfg : IOddCfg<ComboboxCfg>
    {
        ...
        /// </summary>
        public ComboboxCfg Submenu(bool o = true)
        {
            tag.Submenu = o;
            return this;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ComboboxCfg NoSelectClose(bool o = true)
        {
            tag.NoSelClose = true;
            return this;
        }
        ...
        /// <returns></returns>
        public ComboboxCfg PopupMaxWidth(int val)
        {
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public ComboboxCfg ClearBtn(bool o = true)
        {
            tag.ClearBtn = o;
            return this;
        }
