namespace Omu.Awem.Helpers
{
    ...
    public class MultiselectCfg : IOddCfg<MultiselectCfg>
    {
        ...
        /// </summary>
        public MultiselectCfg Submenu(bool o = true)
        {
            tag.Submenu = o;
            return this;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public MultiselectCfg NoSelectClose(bool o = true)
        {
            tag.NoSelClose = o;
            return this;
        }
        ...
        /// <returns></returns>
        public MultiselectCfg PopupMaxWidth(int val)
        {
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public MultiselectCfg ClearBtn(bool o = true)
        {
            tag.ClearBtn = o;
            return this;
        }
