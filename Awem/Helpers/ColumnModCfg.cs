...
namespace Omu.Awem.Helpers
{
    ...
    public class ColumnModCfg : IInlColBuilder
    {
        ...
        {
            this.column = column;
            tag.Format = new List<InlElm>();
            tag.Filters = new List<FilterElm>();
        }
        ...
        /// <returns></returns>
        public ColumnModCfg InlineFunc(string func)
        {
            tag.FormatFunc = func;
            return this;
        }
        ...
        /// </summary>
        /// <param name="el"></param>
        public ColumnModCfg AddInline(InlElm el)
        {
            tag.Format.Add(el);
            return this;
        }
        ...
        /// </summary>
        /// <param name="el"></param>
        public ColumnModCfg AddFilter(FilterElm el)
        {
            tag.Filters.Add(el);
            return this;
        }
