namespace Omu.Awem.Helpers
{
    ...
    public class OddCfg : IOddCfg<OddCfg>
    {
        ...
        /// </summary>
        public OddCfg Submenu(bool o = true)
        {
            tag.Submenu = o;
            return this;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public OddCfg NoSelectClose(bool o = true)
        {
            tag.NoSelClose = o;
            return this;
        }
        ...
        /// <returns></returns>
        public OddCfg PopupMaxWidth(int val)
        {
        ...
        /// </summary>
        public OddCfg Favs(int count = 3, object[] favs = null, object[] frozen = null)
        {
            tag.Favs = favs ?? new object[]{};
            tag.FrozenFavs = frozen ?? new object[]{};
            tag.FavCount = count;
            return this;
        }
        ...
        /// Add clear button
        /// </summary>
        public OddCfg ClearBtn(bool enable = true)
        {
            tag.ClearBtn = enable;
            return this;
        }
